...
$GLOBALS['TL_DCA']['tl_vcard'] = [
    ...
    'list' => [
        'sorting' => [
            ...
            'fields' => ['lastname', 'organizationName'],
    ...
    'palettes' => [
        ...
        'org' => 'kind;{general_legend},organizationName,logo,tags,language,timezone;{contact_legend},addresses,phones,emailAddresses,urls;{calendar_legend},calendarURL,calendarRequestURL,calendarFreeBusyURL;{notes_legend},note',
    ],
    'fields' => [
        'id' => [
        ...
        'logo' => [
            'inputType' => 'fileTree',
            'eval' => ['filesOnly' => true, 'fieldType' => 'radio', 'tl_class' => 'w50 clr'],
            'sql' => 'binary(16) NULL',
        ],
        'company' => [
            'search' => true,
